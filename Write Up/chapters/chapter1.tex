...
A causal effect can be seen on an individual level if the difference $\; Y_i^{\, a=1} \neq Y_i^{\, a=0}$ is signifcant.  By considering how each individual's responses to varying treatments differ, causation (or lack thereof) can easily be determined using paired differences of the form 
