...
\label{AppendixA}
\begin{figure}[h!]
\includegraphics[width = 1.1\linewidth]{figures/schematics.jpeg}
\caption[Schematic of the Python Functions For Both Methods]{This schematic shows how the above functions in Python can be utilized in relation to each other in order to execute the two methods.  Black rectangles represent functions.  Circles represent inputs/outputs, red showing function outputs and grey showing user inputs.}
...
\caption[Histogram of simulation results under the null hypothesis]{A histogram showing the results of the 1,000 simulations.  The y-axis shows frequency of value and the x-axis shows the causal treatment effect estimates.}
\label{bighistogram}
\end{figure}
...
\centering
\begin{tabular} {c | c  c}
Models Correctly Specified & \shortstack{Average Bias \\ of Estimate}  & \shortstack{Std. Error \\of Bias} \\ 
\hline  \\
